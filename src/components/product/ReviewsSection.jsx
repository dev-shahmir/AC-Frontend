    ...
    <div className="mt-12 sm:mt-16 pt-8 sm:pt-12 px-2 sm:px-0">
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-6 sm:mb-8 gap-4 sm:gap-0">
        <div className="w-full sm:w-auto">
          ...
          {allReviews.length > 0 && (
            <div className="flex items-center gap-2 flex-wrap">
              ...
              <span className="text-xs sm:text-base text-primary poppins-regular">
        ...
        <button
          ...
          className="bg-[#ffefcc] cursor-pointer border border-primary poppins-medium text-[#80011f] px-4 sm:px-6 py-2 sm:py-3 rounded-lg hover:bg-[#80011f] hover:text-[#ffefcc] transition-colors text-sm sm:text-base w-full sm:w-auto whitespace-nowrap"
        >
          Add Review
        </button>
      </div>
              ...
              <div className="flex items-start gap-3 sm:gap-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="break-words">
                    <p className="text-primary poppins-regular leading-relaxed text-sm sm:text-base word-wrap break-words">
