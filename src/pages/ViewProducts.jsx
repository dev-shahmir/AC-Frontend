...
const ViewProducts = () => {
  ...
  const fetchProducts = async () => {
    setLoading(true);
    try {
      const response = await instance.get("/products/all-admin-products");
  ...
  const confirmDelete = () => {
    if (productToDelete) {
      instance
        .delete(`/products/remove-product/${productToDelete._id}`)
        .then(() => {
                ...
                <div className="block sm:hidden">
                  ...
                  <div className="flex gap-2">
                    ...
                    <button
                      ...
                      className="flex-1 bg-yellow-500 hover:bg-yellow-600 text-white px-3 py-2 rounded-lg text-xs font-medium transition-colors flex items-center justify-center gap-1"
                    >
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-start justify-between">
                      ...
                      <div className="flex gap-2 flex-shrink-0">
                        ...
                        <button
                          onClick={() => updateProduct(product)}
                          className="bg-yellow-500 hover:bg-yellow-600 text-white px-3 py-2 rounded-lg text-sm font-medium transition-colors flex items-center gap-1"
                        >
