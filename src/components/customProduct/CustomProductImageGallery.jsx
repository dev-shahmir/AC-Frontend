...
const CustomProductImageGallery = ({ images, productName }) => {
  ...
  return (
    <div className="space-y-1 sm:space-y-3">
      <div className="relative overflow-hidden rounded-lg p-8 sm:p-4">
          ...
          {images.map((image, index) => (
            <div key={index} className="outline-none">
              <img
                src={image}
                alt={productName}
                className="w-full h-full p-[3px] sm:h-96 md:h-[900px] lg:h-[600px] object-fill rounded-xl"
              />
            </div>
          ))}
        </Slider>
...
export default CustomProductImageGallery;